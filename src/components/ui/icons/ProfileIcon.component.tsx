...
const ProfileIcon: FC<IIcon> = ({ strokeOpacity, colored = true, filled, ...props }) => {
  return (
    <Icon>
      <svg
        {...props}
      ...
      >
        <path
          ...
          stroke={colored ? '#000000' : '#989898'}
          strokeOpacity={colored ? strokeOpacity : 1}
          strokeWidth="1.5"
          strokeLinecap="round"
